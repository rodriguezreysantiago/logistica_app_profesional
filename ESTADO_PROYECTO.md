...
Documento de handoff para retomar trabajo en otra máquina o en una conversación nueva con Claude. Última actualización: **2026-05-06 (sesión nocturna Mac)** — primer `flutter run` iOS en simulador OK + setup hooks Mac + pre-flight TestFlight (Info.plist completo). Cuenta Apple Developer Individual contratada, esperando activación (~24h).
