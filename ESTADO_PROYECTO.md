...
Documento de handoff para retomar trabajo en otra máquina o en una conversación nueva con Claude. Última actualización: **2026-05-05** (Android App Distribution + fixes bot/storage).
...
- **Plataformas activas**: Windows desktop (admin desde la oficina), Android (choferes) e iOS (soporte generado 2026-05-04 desde Mac — bundle ID en `project.pbxproj` pendiente de corregir a `com.coopertrans.movil` antes del primer build). Web compila pero los reportes Excel se desactivan ahí (toca `dart:io`).
