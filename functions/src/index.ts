...
// Exportada para que icm.ts (extraído en split 2026-05-18) la pueda
// importar sin acoplarse a otro módulo. Si en el futuro hay un drift
// cliente-server (mencionado en el comment arriba) considerar moverla
// a un doc Firestore `META/icm_config.tipos_peligrosos` leído por ambos
// lados con cache TTL.
