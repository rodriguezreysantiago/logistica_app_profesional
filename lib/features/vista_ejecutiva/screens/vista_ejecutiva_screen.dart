...
// (Diego/Carlos) y para que el admin/supervisor vea el estado general
// en 5 segundos antes de meterse en módulos específicos.
//
// Iteración 1 (2026-05-16): solo el tablero. Iteración 2 (futuro):
// agregar tab "Mapa de Flota en vivo" reusando AdminMapaFlotaScreen
// (refactor para que se renderice embebido).
